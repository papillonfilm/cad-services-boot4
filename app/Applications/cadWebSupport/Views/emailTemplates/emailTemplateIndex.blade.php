...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href='{{route('createEmailTemplate')}}' class='btn btn-xs btn-success '  style='float:right'>Add Email Template</a>
        </div>
        <div class='card-body'>
            <div class="row">
                <div class="col-md-12">
                    <table id="myTable" class="table table-bordered table-hover responsive nowrap" width="100%">
                        ...
                        @if(count($emailTemplates) > 0)
                            @foreach ($emailTemplates as $indexKey => $emailTemplate)

                                <tr>
                                    <td><a href="{{route('selectEmailTemplate', $emailTemplate->id)}}">{{ $emailTemplate->title }}</a></td>
                                        ...
                                        <div class="btn-group" style="min-width: 69px;">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{route('editEmailTemplate', $emailTemplate->id)}}"><i class="fa fa-pencil"></i>Edit</a>
                                                </div>
                                            </div>
                                        </div>
