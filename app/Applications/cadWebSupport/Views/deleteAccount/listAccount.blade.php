                        ...
                        <table id="myTable" class="table table-bordered table-hover responsive nowrap" width="100%">
                            ...
                            @if(count($users) > 0)
                                @foreach ($users as $indexKey => $user)
                                    ...
                                    <tr>
                                        <td><a href="{{route('deleteAccountEmail', [$user->user_id, $user->email_addr_id]) }}">{{ $user->user_id }}</a></td>
                                        <td>{{ $user->bar_num }}</td>
                                            ...
                                            <div class="btn-group" style="min-width: 69px;">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="{{route('deleteAccountEmail', [$user->user_id, $user->email_addr_id])}}"><i class="fa fa-eye"></i>Select</a>
                                                    </div>
                                                </div>
                                            </div>
