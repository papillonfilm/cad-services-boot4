                        ...
                        @if(count($users) > 0)
                            @foreach ($users as $indexKey => $user)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#confirm-change" id="formdelete_{{$indexKey}}" data-toggle="modal" class="btn btn-danger submitBtn">Reset Password</a>
                                        <input type="hidden" id="userId_{{$indexKey}}" value="{{ $user->user_id }}">
                                        <input type="hidden" id="email_{{$indexKey}}" value="{{ $user->email_addr }}">
                                    </td>
                                </tr>
    ...
    <div class="modal fade" id="confirm-change" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" id="deleteform" name="deleteform" method="POST" action="{{route('resetAccountPassword')}}">

                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="myModalLabel">Confirm Rest Password</h4>
                    </div>

                    <div class="modal-body">

                        <div>
                            <p>You are about to reset the password on this account. This procedure is irreversible.</p>
                        ...
                        <input type="hidden" name="formEmail" id="formEmail">
...
@section('javascript')
    ...
    <script type="application/javascript">
        ...
        $('.submitBtn').on('click' , function() {
            ...
            $('#formEmail').val($('#email_' + count).val());
